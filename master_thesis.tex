...
\item Transforming the images to grey-scale (in some experiments), illustrated in \autoref{fig:preproc-leuk} (b).
\end{itemize}
...
\item What informations are reliable to the training of a neural network? Is color needed to enhance the training? Is the direction of the images a impacting feature, i.e. are rotations and flips really relevant in this type of images?  
\item Can we still obtain good prediction rate? 
\end{itemize} 

\begin{figure}[H]
  \centering
  \includegraphics[scale=1]{figures/preproc-leuk.PNG}
  \caption{Example of preprocessing to an image of the dataset ALL-IDB1. (a) Image resized to 100x100 pixels, (b) grey-scale applied to the resized image.}
...
\item \textbf{Max-Pooling layers:} one pooling layers after each convolutional layer (then total of two) of size 2x2. 
...
The following experiments are mainly based on the experiments done by Ahmed et al in their article \cite{leukemia}. In addition to my results, the results obtained by the authors of this article are also taken over in order to compare them and see the impact of the preprocessing. 
...
\begin{itemize}
\item \textit{Experiment 1 - Baseline:} runs on the resized images of size 100x100 in color using the baseline CNN: no dropout and no data augmentation.  

\item \textit{Experiment 2 - Greyscale:} runs on the resized images of size 100x100 in greyscale using the baseline CNN: no dropout and no data augmentation.  

\item \textit{Experiment 3 - Dropout:} runs on the resized images of size 100x100 in color using dropout set to 0.1 with no data augmentation. 
 
\item \textit{Experiment 4 - Data augmentation:} runs on the data augmented dataset (described in \autoref{sec:data-aug-leuk}) with no dropout.   

\item \textit{Experiment 5 - Dropout and data augmentation:} runs on the data augmented dataset (described in \autoref{sec:data-aug-leuk}) using dropout set to 0.1. 
\end{itemize}
...
TODO: 
\begin{itemize}
\item Résultats ALL-IDB1 et ALL-IDB2 done : à rédiger 
\item All datasets : résultats à avoir + rédiger 
\end{itemize}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{Code/ch6-LeukemiaSubtypes/figures_result/all_idb1-baseline.PNG}
  \caption{}
  \label{fig:all_idb1-baseline}
\end{figure}

\subsubsection{Experiment A.2 - Greyscale}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{Code/ch6-LeukemiaSubtypes/figures_result/all_idb1-grey.PNG}
  \caption{}
  \label{fig:all_idb1-grey}
\end{figure}

\subsubsection{Experiment A.3 - Dropout}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{Code/ch6-LeukemiaSubtypes/figures_result/all_idb1-dropout.PNG}
  \caption{}
  \label{fig:all_idb1-dropout}
\end{figure}

\subsubsection{Experiment A.4 - Data augmentation}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{Code/ch6-LeukemiaSubtypes/figures_result/all_idb1-data_aug.PNG}
  \caption{}
  \label{fig:all_idb1-data_aug}
\end{figure}

\subsubsection{Experiment A.5 - Dropout and data augmentation}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{Code/ch6-LeukemiaSubtypes/figures_result/all_idb1-data_aug_and_dropout.PNG}
  \caption{}
  \label{fig:all_idb1-data_aug_and_dropout}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{Code/ch6-LeukemiaSubtypes/figures_result/all_idb2-baseline.PNG}
  \caption{}
  \label{fig:all_idb2-baseline}
\end{figure}

\subsubsection{Experiment B.2 - Greyscale}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{Code/ch6-LeukemiaSubtypes/figures_result/all_idb2-grey.PNG}
  \caption{}
  \label{fig:all_idb2-grey}
\end{figure}

\subsubsection{Experiment B.3 - Dropout}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{Code/ch6-LeukemiaSubtypes/figures_result/all_idb2-dropout.PNG}
  \caption{}
  \label{fig:all_idb2-dropout}
\end{figure}

\subsubsection{Experiment B.4 - Data augmentation}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{Code/ch6-LeukemiaSubtypes/figures_result/all_idb2-data_aug.PNG}
  \caption{}
  \label{fig:all_idb2-data_aug}
\end{figure}

\subsubsection{Experiment B.5 - Dropout and data augmentation}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.8]{Code/ch6-LeukemiaSubtypes/figures_result/all_idb2-data_aug_dropout.PNG}
  \caption{}
  \label{fig:all_idb2-data_aug_dropout}
\end{figure}

\subsection{Case C - All datasets}
\subsubsection{Experiment C.1 - Baseline}
\subsubsection{Experiment C.2 - Greyscale}
\subsubsection{Experiment C.3 - Dropout}
\subsubsection{Experiment C.4 - Data augmentation}
\subsubsection{Experiment C.5 - Dropout and data augmentation}
